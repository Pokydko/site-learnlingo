...
const DynamicImage = () => {
  ...
  htmlElement.style.setProperty("--btn-color", btnColor);
  // htmlElement.style.setProperty("--appleColor1", appleColor1);
  // htmlElement.style.setProperty("--appleColor2", appleColor2);
  useEffect(() => {
  ...
  return (
    <div className={css.imageBg}>
      <div className={css.imageContainer}>
        ...
        >
          {/* <title>Tap on elements to change colors</title> */}
          <g>
            <path
